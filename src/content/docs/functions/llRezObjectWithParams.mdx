...
* This function causes the script to sleep at least for <InlineSyntax code="0.1"/>s and uses <InlineSyntax code="200.0"/> energy — this energy deficiency can cause scripts across the entire linkset to skip for two sim frames (<InlineSyntax code="0.022"/>s)

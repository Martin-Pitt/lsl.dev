...
```lsl title="Example" frame="terminal" collapse={1-4, 8-9}
default {
	touch_start(integer detected)
	{
		// When touched the script tries to rez an item named "Object" from object inventory at region position <128, 128, 32>
